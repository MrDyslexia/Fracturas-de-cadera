...
module.exports = (sequelize) => {
  ...
  const ControlClinico = sequelize.define("ControlClinico", {
    ...
    profesional_nombre: { type: DataTypes.STRING(150), allowNull: true },
    origen: { type: DataTypes.ENUM("Guardado","Minuta","Otro"), defaultValue: "Guardado" },
    tipo_control: {
      type: DataTypes.ENUM("INICIAL", "SEGUIMIENTO", "INTERCONSULTA", "ALTA", "OTRO"),
      allowNull: false,
    ...
    comorbilidades: { type: DataTypes.JSONB, allowNull: true, defaultValue: null },
    tabaco: { type: DataTypes.BOOLEAN, allowNull: true, defaultValue: null },
    alcohol: { type: DataTypes.BOOLEAN, allowNull: true, defaultValue: null },
    corticoides_cronicos: { type: DataTypes.BOOLEAN, allowNull: true, defaultValue: null },
    taco: { type: DataTypes.BOOLEAN, allowNull: true, defaultValue: null },
    ...
    complicaciones: { type: DataTypes.JSONB, allowNull: true, defaultValue: null },
    transfusion: { type: DataTypes.BOOLEAN, allowNull: true, defaultValue: null },
    reingreso: { type: DataTypes.BOOLEAN, allowNull: true, defaultValue: null },
  }, {
