...
export default function Page() {
  ...
  return (
    <RoleGuard allow={["tecnologo"]}>
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-slate-900">Subir biopsia / anatomía patológica </h1>
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="flex-1 space-y-2">
              <span className="text-sm font-medium text-slate-700 flex items-center gap-2">
                ...
                Adjuntar imágenes microscópicas (opcional)
              </span>
              <div
                className={`relative border-2 border-dashed rounded-2xl p-8 text-center transition-all duration-300 ${
                  isDragOverImages
                ...
                {selectedImages.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 px-3 py-1 bg-slate-100 rounded-full text-xs text-slate-600">
                      ...
                      <span>JPG, PNG y otros formatos de imagen</span>
                    </div>
                  </div>
                )}
              </div>
