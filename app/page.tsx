    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
          ...
          <section className="col-span-1 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 lg:col-span-5">
            <div className="mb-6 flex items中心 gap-3">
              ...
              <h2 className="text-xl font-semibold">
                Distribución por tipo de fractura
              </h2>
            </div>
        ...
        <section className="mt-10 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-semibold">
              Panorama de las fracturas de cadera
            </h3>
          </div>
          ...
          <p className="mt-5 text-slate-700">
            El envejecimiento acelerado incrementa la demanda de atención
            geriátrica, rehabilitación y{" "}
            <span className="font-medium">prevención secundaria</span>. Las
            fracturas de cadera representan un desafío creciente para los
            sistemas de salud, requiriendo estrategias.
          </p>
          ...
          {expanded && (
            <div className="prose prose-slate mt-3 max-w-none text-sm">
              <p>
                Esta plataforma centraliza datos clínicos para análisis por
                cohorte o paciente, mejora la trazabilidad y habilita decisiones
                basadas en evidencia. Ofrece acceso segmentado y métricas clave
                para profesionales de salud y gestores.
              </p>
            </div>
          )}
        </section>
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-6 text-sm text-slate-500">
          © {new Date().getFullYear()} Registro de Fracturas de Cadera —
          Hospital.
        </div>
      </footer>
    </div>
