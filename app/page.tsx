...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative w-1/2 h-screen hidden lg:block overflow-hidden animate-slide-in-left">
        <Image
        ...
        <div className="absolute inset-0 bg-transparent flex items-center justify-center">
          <div className="text-center text-white px-8 animate-fade-in-slide animation-delay-[0.4s]">
      ...
      {/* Panel de login */}
      <div className="w-full lg:w-1/2 bg-gradient-to-br from-blue-50 via-blue-100 to-blue-200 flex flex-col justify-center px-8 lg:px-16 py-12 relative overflow-hidden rounded-lg shadow-2xl animate-fade-in-slide animation-delay-[0.2s] animate-gradient-shift bg-[length:200%_200%]">
